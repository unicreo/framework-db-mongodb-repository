...
- Package Manager:   `Install-Package Unicreo.Framework.Db.MongoDB.Repository -Version 1.0.3`
- .NET CLI: `dotnet add package Unicreo.Framework.Db.MongoDB.Repository --version 1.0.3`
- PackageReference `<PackageReference Include="Unicreo.Framework.Db.MongoDB.Repository" Version="1.0.3" />`
- Paket CLI `paket add Unicreo.Framework.Db.MongoDB.Repository --version 1.0.3`
